...
export const CandyMint: FC = () => {
    ...
    return (
        ...
        <div className="mintDetails">
            <button className='gradient-button' onClick={onClick}>Mint NFT</button>
            <div className='others'><span className='othersT'>Price</span> 0.2 SOL</div>
            <div  className='others'><span className='othersT'>Minted</span> {_itemsRedeemed}/1, 000</div>
            {/*<div>{_itemsLoaded} Total Supply</div>*/}
        </div>
